...
import Unillanos.AsistenciaMonitor.service.helpers.SemestreServiceHelper;
...
public class SemestreService {
    ...
    @Autowired
    private SemestreServiceHelper semestreHelper;
    @Autowired
    ...
    public Semestre crearSemestre(String nombre, LocalDate fechaInicio, LocalDate fechaFin) {
        boolean solapado = semestreHelper.obtenerSemestrePorFecha(fechaInicio, fechaFin);
    ...
    public void eliminarSemestre(Long id) {
        boolean modificable = semestreHelper.validarExistenciaMonitoresEnSemestreId(id);
    ...
    public ResponseCreateSemestreDTO editarSemestre(Long id, RequestCreateSemestreDTO semestreDTO) {
        Semestre semestre = semestreHelper.obtenerSemestrePorId(id);
